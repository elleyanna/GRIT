...
var _pageContextManager = require('scripts/pageContextManager.js');

document.addEventListener('DOMContentLoaded', function () {
  tonic.contextManager = new _pageContextManager.PageContextManager();
  tonic.contextManager.initialize($('#page-container').data('page-type'));
});

});

require.register("scripts/pageContextManager.js", function(exports, require, module) {
"use strict";
...
var PageContextManager = function () {
  function PageContextManager() {
    _classCallCheck(this, PageContextManager);
  }

  _createClass(PageContextManager, [{
    key: "initialize",
    value: function initialize(pageType) {}
  }]);

  return PageContextManager;
}();

exports.PageContextManager = PageContextManager;

});

require.register("scripts/parallax.js", function(exports, require, module) {
'use strict';
...
var Parallax = function () {
  ...
  _createClass(Parallax, [{
    ...
    key: 'isParallaxContainerInView',
    value: function isParallaxContainerInView(parrallaxContainer) {
      var viewport = {
    ...
    value: function parallaxScroll() {
      ...
      $('.parallax-container').toArray().forEach(function (parallaxContainer) {
        if (_this.isParallaxContainerInView(parallaxContainer)) {
...
require.register("scripts/recruiterBox.js", function(exports, require, module) {
'use strict';
...
var RecruiterBox = function () {
  function RecruiterBox() {
    _classCallCheck(this, RecruiterBox);

    this.recruiterBoxBaseUrl = 'https://jsapi.recruiterbox.com/v1/';
    this.recruiterBoxClient = 'tonic';
  }

  _createClass(RecruiterBox, [{
    key: 'fetchAllOpenings',
    value: function fetchAllOpenings() {
      var api = 'openings/';
      return this.get(api);
    }
  }, {
    key: 'fetchOpening',
    value: function fetchOpening(id) {
      var api = 'openings/' + id;
      return this.get(api);
    }
  }, {
    key: 'fetchApplicationFields',
    value: function fetchApplicationFields(id) {
      var api = 'openings/' + id + '/application_form';
      return this.get(api);
    }
  }, {
    key: 'submitApplication',
    value: function submitApplication(id, data) {
    ...
    key: 'post',
    value: function post(api, payLoad) {
      return $.ajax({
        url: this.recruiterBoxBaseUrl + api + '/?client_name=' + this.recruiterBoxClient,
...
exports.RecruiterBox = RecruiterBox;

});

require.register("scripts/slider.js", function(exports, require, module) {
'use strict';
...
var _swipe = require('scripts/swipe.js');
...
var Slider = function () {
  ...
  _createClass(Slider, [{
    ...
    value: function initialize() {
      ...
      this.swipe.setOnLeft(function () {
        self.handleClickForward();
      });
      this.swipe.setOnRight(function () {
    ...
    key: 'addSlideIndexes',
    value: function addSlideIndexes() {
    ...
    key: 'addSlideTotal',
    value: function addSlideTotal() {
      this.slideTotal.append('/ ' + this.formatNumber(this.slideLength, 2));
    }
  }, {
    key: 'formatNumber',
    value: function formatNumber(number, targetLength) {
      var output = number + '';
    ...
    key: 'setUpSlideCounter',
    value: function setUpSlideCounter() {
    ...
    value: function handleClickForward() {
      var nextPageIndex;
      if (this.transitionInProgress) {
        return;
      }
      nextPageIndex = this.currentIndex + 1;
      if (this.nextPageisInvalid(nextPageIndex)) {
        return;
      }
    ...
    key: 'handleClickBackward',
    value: function handleClickBackward() {
      var nextPageIndex;
      if (this.transitionInProgress) {
        return;
      }
    ...
    key: 'nextPageisInvalid',
    value: function nextPageisInvalid(nextPageIndex) {
      return nextPageIndex >= this.slideLength || nextPageIndex < 0;
    }
  }, {
    key: 'getDirectionOperator',
    value: function getDirectionOperator(nextPageIndex) {
      var directionOperator = null;
      return nextPageIndex > this.currentIndex ? directionOperator = '-' : directionOperator = '+';
    }
  }, {
    key: 'getTopAnimationParams',
    value: function getTopAnimationParams(nextPageIndex, distance) {
      return {
    ...
    key: 'animateCounter',
    value: function animateCounter(nextPageIndex) {
    ...
    key: 'transitionPage',
    value: function transitionPage(nextPageIndex, xPosition, transitionClass) {
      var self = this;
...
require.register("scripts/swipe.js", function(exports, require, module) {
'use strict';
...
var Swipe = function () {
  function Swipe() {
    ...
    this.setOnUp(function () {
      return;
    });
    this.setOnDown(function () {
      return;
    });
    this.setOnLeft(function () {
      return;
    });
    this.setOnRight(function () {
      return;
    });
  ...
  _createClass(Swipe, [{
    key: 'initialize',
    value: function initialize(element, preventDefault) {
    ...
    key: 'setOnLeft',
    value: function setOnLeft(callback) {
      this.onLeft = callback;
      return this;
    }
  }, {
    key: 'setOnRight',
    value: function setOnRight(callback) {
      this.onRight = callback;
      return this;
    }
  }, {
    key: 'setOnUp',
    value: function setOnUp(callback) {
      this.onUp = callback;
      return this;
    }
  }, {
    key: 'setOnDown',
    value: function setOnDown(callback) {
